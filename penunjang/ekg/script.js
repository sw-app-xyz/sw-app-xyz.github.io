...
let tombolKetikanEkg = document.querySelector('#tombolKetikanEkg');
...
// TOMBOL
tombolKetikanEkg.addEventListener('click', () => {
    ...
    let hasilTujuan;
    if (tujuan.value !== "") {
      hasilTujuan = fungsiDokter(tujuan.value);
    } else {
      hasilTujuan = "Anindita, Sp.JP";
    }
    ...
    if (hasilTujuan !== '') {
      ...
      ketikan.innerHTML +=
      `Selamat ${hasilPssom} dokter ${hasilTujuan}, mohon maaf mengganggu waktunya. Izin melaporkan hasil EKG pasien:
      <br>
      ...
      ketikan = document.createElement('p');
      ketikan.innerHTML +=
      `Selamat ${hasilPssom} dokter, mohon maaf mengganggu waktunya. Izin melaporkan hasil EKG pasien:
      <br>
      <br>*${hasilNama}, ${hasilKelamin}, ${hasilUmur} th, ${hasilPayer}*
      <br>
      <br>*Diagnosis:*
