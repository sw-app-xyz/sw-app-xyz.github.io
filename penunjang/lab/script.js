...
let tombolKetikanLab = document.querySelector('#tombolKetikanLab');
...
// TOMBOL
tombolKetikanLab.addEventListener('click', () => {
    ...
    if (hasilTujuan !== '') {
      ...
      ketikan.innerHTML +=
      `Selamat ${hasilPssom} dokter ${hasilTujuan}, mohon maaf mengganggu waktunya. Izin melaporkan hasil lab pasien:
      <br>
      ...
      ketikan = document.createElement('p');
      ketikan.innerHTML +=
      `Selamat ${hasilPssom} dokter, mohon maaf mengganggu waktunya. Izin melaporkan hasil lab pasien:
      <br>
      <br>*${hasilNama}, ${hasilKelamin}, ${hasilUmur} th, ${hasilPayer}*
      <br>
      <br>*Diagnosis:*
