...
let tombolKetikanRaber = document.querySelector('#tombolKetikanRaber');
...
// TOMBOL
tombolKetikanRaber.addEventListener('click', () => {
    ...
    if (hasilTujuan !== '') {
      ...
      ketikan.innerHTML +=
      `Selamat ${hasilPssom} dokter ${hasilTujuan}, mohon maaf mengganggu waktunya. Izin menginfokan rencana raber pasien:
      <br>
      <br>*${hasilNama}, ${hasilKelamin}, ${hasilUmur} th, ${hasilPayer}*
      <br>
      <br>*DPJP: dr. ${hasilDpjp}*
      <br>*Alasan raber: ${hasilAlasan}*
      <br>
      <br>*Diagnosis:*
      <br>${hasilDiagnosis}
      <br>
      ...
      ketikan = document.createElement('p');
      ketikan.innerHTML +=
      `Selamat ${hasilPssom} dokter, mohon maaf mengganggu waktunya. Izin menginfokan rencana raber pasien:
      <br>
      <br>*${hasilNama}, ${hasilKelamin}, ${hasilUmur} th, ${hasilPayer}*
      <br>
